 ...
 * @constructor
 */
 function MyInvertedSphere(scene, args) 
 {
 ...
 MyInvertedSphere.prototype = Object.create(CGFobject.prototype);
 MyInvertedSphere.prototype.constructor = MyInvertedSphere;

 MyInvertedSphere.prototype.initBuffers = function() 
 {
...
MyInvertedSphere.prototype.updateTextCoords = function(ampS,ampT){
